...
class VideoState extends MusicBeatState
{
	...
	public var pauseText:String = "Pressione SPACE para Pause/Play";
	...
	override function create()
	{
		...
		add(bg);
		var html5Text:String = "Voce nao esta usando HTML5...\nO video nao foi carregado!";
		if (isHTML)
		{
			html5Text = "Voce esta usando HTML5!";
		}
		defaultText = "Se voce esta usando HTML5\nAperte qualquer tecla...\nO texto inferior\nira dizer se voce esta usando HTML5...\n\n" + html5Text;
